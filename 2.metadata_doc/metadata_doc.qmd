...
```{r, personnel_table, echo = FALSE, message= FALSE, warning= FALSE}
...
```{r, personnel_table_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, keywords_table_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, funding_table, echo = FALSE, message= FALSE, warning= FALSE, message= FALSE, warning= FALSE}
...
```{r, funding_table_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, timeframe_table, echo = FALSE, message= FALSE, warning= FALSE}
...
```{r, data_provenance, echo = FALSE, message= FALSE, warning= FALSE}
...
```{r, provence_table_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, table_description_table_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, script_info, echo = FALSE, message= FALSE, warning= FALSE}
...
```{r, script_info_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, other_objects, echo = FALSE, message= FALSE, warning= FALSE}
...
```{r, other_objects_export, echo=FALSE, message= FALSE, warning= FALSE}
...
```{r, publications_export, echo=FALSE, message= FALSE, warning= FALSE}
